    ...
    class Program
    {
        ...
        public static string ImportQG()
        {
            ...
            while (xh)
            {
                ...
                {
                    if (item["proNo"] == null||SPMList.Select(" SpmCode='" + item["proNo"].ToString() + "'").Length == 0)
                    {
                        continue;
                    }
                    else
            ...
            while (xh)
            {
                ...
                foreach (JObject item in SpmDataList)
                {
    ...
    
                    {
                        ...
                        d.EpsProjName = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_name"].ToString();
                        d.ProfName = item["zhuanye"]==null?"": item["zhuanye"].ToString();
                        d.EquipName = item["材料描述"].ToString();
                        d.Unit = item["单位"] == null ? "" : item["单位"].ToString();
                        ...
                        d.SendRate = float.Parse(item["发放百分百"].ToString().Substring(0, item["发放百分百"].ToString().Length - 1));

                        d.StoreNum = float.Parse(item["库存总量"].ToString());
                        d.ProfName = item["专业"] == null ? "" : item["专业"].ToString();
                        //补充缺省列
                        //处理缺省列
                        d.ID = Guid.NewGuid();
                        d.TableName = "NPS_BID_StatusTable";
                        ...
                        d.RegPosiId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.RegDeptId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.EpsProjId = Guid.Parse(Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_guid"].ToString());
                        d.RecycleHumId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.UpdHumId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.UpdHumName = "系统管理员";
                        d.UpdDate = DateTime.Now;
                        d.OwnProjId = Guid.Parse(Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_guid"].ToString());
                        d.OwnProjName = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_name"].ToString();
                        d.EpsProjCode = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_shortname"].ToString();
                        d.EpsProjName = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_name"].ToString();
                        InsertDt.Add(d);
                    }
        ...
        public static string ImportFbcldh()
        {
            ...
            while (xh)
            {
                ...
                foreach (JObject item in SpmDataList)
                {
                    if (item["项目ID"] ==null||SPMList.Select(" SpmCode='" + item["项目ID"].ToString() + "'").Length == 0)
                    {
                        continue;
                    }
                    else
                    {
                        ...
                        d.SendRate = float.Parse(item["发放量"].ToString()) > float.Parse(item["bom量"].ToString())?0:float.Parse(item["发放量"].ToString()) / float.Parse(item["bom量"].ToString())*100;
                        //补充缺省列
                        //处理缺省列
                        d.ID = Guid.NewGuid();
            ...
            while (xh)
            {
                ...
                foreach (JObject item in SpmDataList)
                {
                    ...
                    else
                    {
                        ...
                        //d.EpsProjName= item["材料描述"].ToString();
        ...
        public static string ImportFF()
        {
            ...
            while (xh)
            {
                ...
                foreach (JObject item in SpmDataList)
                {
                    if (item["proName"] == null||SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'").Length == 0)
                    {
                        continue;
                    }
                    else
                    {
                        ...
                        d.ProjectDep = Project.Select(" project_guid='" + Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["parent_guid"] + "'")[0]["project_name"].ToString();
                        d.EpsProjName = item["proName"].ToString();
                        ...
                        d.RegPosiId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.RegDeptId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.EpsProjId = Guid.Parse(Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_guid"].ToString());
                        d.RecycleHumId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.UpdHumId = Guid.Parse("00000000-0000-0000-0000-000000000000");
                        d.UpdHumName = "系统管理员";
                        d.UpdDate = DateTime.Now;
                        d.OwnProjId = Guid.Parse(Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_guid"].ToString());
                        d.OwnProjName = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_name"].ToString();
                        d.EpsProjCode = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_shortname"].ToString();
                        d.EpsProjName = Project.Select(" project_guid='" + SPMList.Select(" SpmCode='" + item["proName"].ToString() + "'")[0]["EpsProjId"] + "'")[0]["project_name"].ToString();
                        InsertDt.Add(d);
                    }
